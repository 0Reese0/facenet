package cn.edu.nbpt.facenet.model.network;

import cn.edu.nbpt.facenet.model.AbstractModel;
import cn.edu.nbpt.facenet.model.util.ActivationSoftMaxAxis;
import cn.edu.nbpt.facenet.model.util.PReLUNorm;
...
public class PNet extends AbstractModel {
	...
	protected InputStream getModelDataInputStream() throws IOException {
		return Thread.currentThread().getContextClassLoader().getResourceAsStream("data\\PNetData");
	}
}

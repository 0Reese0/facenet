package cn.edu.nbpt.facenet.model;

import cn.edu.nbpt.facenet.model.util.ActivationLinear;
import cn.edu.nbpt.facenet.model.util.ActivationReverse;
...
//		}
	...
	protected InputStream getModelDataInputStream() throws IOException {
		return new MultiResouceInputStream("data\\InceptionResNetV1Data");
	}
}
